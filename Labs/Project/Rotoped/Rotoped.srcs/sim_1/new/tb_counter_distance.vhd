...
------------------------------------------------------------------------
entity tb_counter_distance is
    -- Entity of testbench is always empty
end entity tb_counter_distance; 

------------------------------------------------------------------------
-- Architecture body for testbench
------------------------------------------------------------------------
architecture testbench of tb_counter_distance is
...
begin
    -- Connecting testbench signals with counter_distance entity
    -- (Unit Under Test)
    uut_cnt : entity work.counter_distance
        generic map(
